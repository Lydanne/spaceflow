...
详见：[CI/CD 集成文档](../overview/cicd-integration.md)

### 3. Agents（当前：仓库级 Runtime）

Agents 当前已落地的是仓库级执行模型（System Agent 仍在规划）：
...
详见：[Agents 系统设计](./agents-design.md)、[Agents Runtime 手册](../overview/agents-runtime.md)、[Agents 当前实现文档](./agent-system.md)
...
详见：
- [飞书集成文档](../overview/feishu-integration.md)
...
- [Overview 导航](../overview/index.md) - 使用文档入口
- [Agents 系统设计](./agents-design.md) - 当前已实现的 Agents 方案
- [Agents Runtime 使用与配置](../overview/agents-runtime.md) - Phase 1 Runtime 与 Session 目录配置手册
- [API 规范](./api-specification.md) - 前端路由和后端 API 设计规范
- [权限系统](./permission-system.md) - 管理员体系、权限组、访问控制
- [CI/CD 集成](../overview/cicd-integration.md) - Gitea Actions 集成和 Workflow 管理
- [Agents 当前实现文档](./agent-system.md) - Runtime/Session 的实际实现细节
- [数据库设计](./database-design.md) - 完整的数据库 Schema
- [部署配置](../overview/deployment.md) - Docker Compose 和环境变量
- [飞书集成](../overview/feishu-integration.md) - 飞书通知、机器人、审批
- [飞书卡片交互](./feishu-card-interaction.md) - 交互式卡片表单设计
- [开发计划](../plan/plan.md) - 项目开发进度和里程碑
